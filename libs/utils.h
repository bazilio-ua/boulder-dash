...
#define SCOREBOARD_WIDTH SCOREBOARD_SPRITE_WIDTH *SCOREBOARD_WIDTH_SCALE
#define SCOREBOARD_HEIGHT SCOREBOARD_SPRITE_HEIGHT *SCOREBOARD_HEIGHT_SCALE

#define MARIO_SPRITE_WIDTH 32
#define MARIO_SPRITE_HEIGHT 32
#define MARIO_SCALE 0.5
#define MARIO_WIDTH MARIO_SPRITE_WIDTH *MARIO_SCALE
#define MARIO_HEIGHT MARIO_SPRITE_HEIGHT *MARIO_SCALE
